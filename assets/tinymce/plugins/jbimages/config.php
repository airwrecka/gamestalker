...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/gs/assets/cImg'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/gs/assets/cImg'; // Physical path. [Usually works fine like this]
