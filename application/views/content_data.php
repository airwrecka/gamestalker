...
<div class="col-md-10 col-md-offset-1" style="text-align:center;">
	<div class="well" style="background:grey;word-wrap:break-word;">
 ...
 <form id="addComment" method="post" action="<?php echo base_url();?>gamestalker/storeComment/<?=$id ?>">
    <div>
          <?php echo "Post Comment as ".$this->session->userdata('username');?>
            <textarea class="form-control" required pattern=".{1,}" name="body" placeholder="Insert Comment" id="commenter" cols="20" rows="5"></textarea>
            
            <input class="btn btn-primary" type="submit" id="submit" value="Post Comment" />
    </div>
...
<div>
 ...
 ?><button class="btn btn-danger"> <a id="deleteComment" href="<?php echo base_url();?>gamestalker/deleteComment/<?php echo $c->Co_id; ?>">Delete</a></button> <?php if($c->U_username===$this->session->userdata("username")){?> <button id="editComment" class="btn btn-primary" value="<?php echo $c->Co_id; ?>">Edit</button> <?php }?>
<?php } 
