...
<script type="text/javascript" src="<?php echo base_url('assets/js/wysiwyg-editor.js') ?>"></script>
...
<link href="<?php echo base_url('assets/css/wysiwyg-editor.css') ?>" rel="stylesheet" />
