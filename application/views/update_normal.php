	...
	<h1>Edit User Information</h1>
		...
		<div class="form-group">
          ...
          <p>Desired Username     <input class="form-control-reg" pattern=".{8,}" maxlength="24" required title="Input should be 8 characters at minimum." type="text" name="uname" id="USERNAME" placeholder="Username" value="<?php echo $info->U_username;?>"></p>
              ...
              <p hidden>Status<input type="text" value="1" name="ustatus" id="USERSTATUS2" placeholder="Userstatus" hidden></p>
              <p hidden>Type<input type="text" value="2" name="utype" id="USERTYPE2" placeholder="Usertype" hidden></p>
              <div>
                <p>Apply as Contributor? <input id="CHKBOX2" name="chkbox" type="checkbox" onclick="return changeVal()"></p> 
              </div>
            </div>
        <?php endforeach;?>	
